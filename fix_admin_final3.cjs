...
// Step 1: Add showAbout state after the import line
if (!a.includes('const [showAbout')) {
  ...
  console.log('1: showAbout added at idx', endOfLine);
}

// Step 2: Add AboutSection before the LAST } in the file (which closes the Admin function)
const aboutSection = `
...
a = a.substring(0, lastBrace) + aboutSection + '\r\n' + a.substring(lastBrace);
console.log('2: AboutSection added before last } at', lastBrace);
...
console.log('3: popup inserted before last </div> at', lastDiv);

// Step 4: Version number
if (a.includes('游游记账 v2.0.1')) {
  a = a.replace('游游记账 v2.0.1', '游游记账 v3.0.3');
  console.log('4: version updated');
}

// Step 5: Add export default Admin at the very end
a = a + '\r\nexport default Admin\r\n';
console.log('5: export default Admin added');

fs.writeFileSync('D:/1kaifa/money-tracker/src/pages/Admin.tsx', a, 'utf8');
console.log('Done!');
const v = fs.readFileSync('D:/1kaifa/money-tracker/src/pages/Admin.tsx', 'utf8');
console.log('showAbout:', v.includes('const [showAbout'));
console.log('AboutSection:', v.includes('function AboutSection'));
console.log('v3.0.3:', v.includes('v3.0.3'));
console.log('export default:', v.includes('export default Admin'));
console.log('last 100:', JSON.stringify(v.slice(-100)));
